...
/**add the title */
add_action('cmb2_admin_init', 'yourprefix_register_custom_metabox');

function yourprefix_register_custom_metabox() {
    $prefix = 'yourprefix_'; // Prefix for all fields

    $cmb = new_cmb2_box(array(
        'id'            => $prefix . 'custom_metabox',
        'title'         => __('Custom Meta Box', 'cmb2'),
        'object_types'  => array('post', 'page'), // Post types where the meta box will appear
        'context'       => 'normal',
        'priority'      => 'high',
        'show_names'    => true,
    ));
    ...
    $cmb->add_field(array(
        ...
        'desc' => __('This is a section title', 'cmb2'),
        'type' => 'title',
    ...
    $cmb->add_field(array(
        ...
        'id'   => $prefix . 'images',
        'type' => 'file_list',
        'preview_size' => array(100, 100), // Optionally set image preview size
    ));

    // Wide Gallery field
    $cmb->add_field(array(
        'name' => __('Wide Gallery', 'cmb2'),
        'id'   => $prefix . 'wide_gallery',
        'type' => 'file_list',
        'preview_size' => array(300, 150), // Optionally set wide image preview size
    ));
}
